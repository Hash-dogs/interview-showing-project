...
public class ResumeUploadService {
    ...
    private final ResumeParseService parseService;//简历解析分析
    private final FileStorageService storageService;//建立存储
    private final ResumePersistenceService persistenceService;//持久化？
